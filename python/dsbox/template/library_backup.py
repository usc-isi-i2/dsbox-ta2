...
class TemplateLibrary:
    ...
    def __init__(self, library_dir: str = None, run_single_template: str = "") -> None:
        ...
        self.all_templates = {
            ...
            "JHU_link_prediction_templaTe": JHULinkPredictionTemplate,
...
class JHUGraphTemplate(DSBoxTemplate):
    def __init__(self):
        ...
        self.template = {
            ...
            "taskType": {TaskKeyword.COMMUNITY_DETECTION.name, TaskKeyword.GRAPH_CLUSTERING.name, TaskKeyword.GRAPH_MATCHING.name, TaskKeyword.LINK_PREDICTION.name, TaskKeyword.VERTEX_NOMINATION.name},
            # for some special condition, the taskSubtype can be "NONE" which indicate no taskSubtype given
            "taskSubtype":  {TaskKeyword.COMMUNITY_DETECTION.name, TaskKeyword.GRAPH_CLUSTERING.name, TaskKeyword.GRAPH_MATCHING.name, TaskKeyword.LINK_PREDICTION.name, TaskKeyword.VERTEX_NOMINATION.name},
            "inputType": {"graph"},
            "output": "model_step",
            "steps": [
                {
