...
class metalearning_binary_classification_text_template_1(DSBoxTemplate): 
    def __init__(self):
        DSBoxTemplate.__init__(self)
        self.template =  {
        "weight": 20, 
        'name': 'metalearning_binary_classification_text_template_1', 
            ...
            'primitives': [
                {
                    ...
                    'hyperparameters': {
                        'learning_rate': [0.08139302091020258],
                        'add_index_columns': [True],
                        'min_child_weight': [1],
                        'n_estimators': [56],
                        'return_result': ['new'],
                        'gamma': [0.700274087731817],
                    },
                },
            ],
