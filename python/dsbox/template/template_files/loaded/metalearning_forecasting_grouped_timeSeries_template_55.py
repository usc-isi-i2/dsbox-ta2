...
class metalearning_forecasting_grouped_timeSeries_template_55(DSBoxTemplate): 
    def __init__(self):
        DSBoxTemplate.__init__(self)
        self.template =  {
        "weight": 20, 
        'name': 'metalearning_forecasting_grouped_timeSeries_template_55', 
        'taskType': {'FORECASTING', 'GROUPED', 'TIMESERIES'}, 
        'taskSubtype': {'FORECASTING', 'GROUPED', 'TIMESERIES'}, 
        'inputType': {'table'}, 
    'output': 'steps.8',
    'steps': [
        {
        ...
        },
        {
            ...
            'primitives': [
                {
                    'primitive': 'd3m.primitives.regression.bagging.SKlearn',
                    'hyperparameters': {
                    },
                },
            ],
